...
MagKartik#9949 ©N1-Framework
THAT WORKED ONE DAY FOR THAT BEUTIFULL SCRIPT
AND HE DOESN'T WANT SOMEBODY WILL TAKE HIS CREDIT.                      MADE BY MagKartik#9949 ©N1-Framework
*/
...
function sendSuccsess(fromUser, toUser, code, type, amount, chnl, toUserUN) {
	...
	.setTimestamp()
	.setFooter('Made By MagKartik#9949 ©N1-Framework', logo);
...
client.on('ready', () => {
    ...
    console.log("Made By MagKartik#9949 ©N1-Framework");
});
